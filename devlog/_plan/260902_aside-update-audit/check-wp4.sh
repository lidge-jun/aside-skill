...
if rg -n -i '\bsk-[a-z0-9]{10,}|bearer [a-z0-9]{20,}|"password"\s*:\s*"|xoxb-|ghp_[a-z0-9]{20,}|korea\.ac\.kr|junny6140' aside-jun README.md devlog/_plan/260902_aside-update-audit --glob '!*.png'; then echo "PII"; fail=1; fi
